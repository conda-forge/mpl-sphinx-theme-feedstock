...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mpl-sphinx-theme-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15513&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mpl-sphinx-theme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mpl-sphinx-theme` can be installed with:

```
conda install mpl-sphinx-theme
```

It is possible to list all of the versions of `mpl-sphinx-theme` available on your platform with:
